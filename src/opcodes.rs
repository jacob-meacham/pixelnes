...
pub enum OpCodeType {
    ...
    // Unofficial opcodes from https://www.nesdev.org/undocumented_opcodes.txt
...
lazy_static! {
    pub(crate) static ref OPCODES: Vec<OpCode> = vec![
        ...
        OpCode::new(0x1A, OpCodeType::NOP, AddressingMode::Implicit),
        OpCode::new(0x3A, OpCodeType::NOP, AddressingMode::Implicit),
        OpCode::new(0x5A, OpCodeType::NOP, AddressingMode::Implicit),
        OpCode::new(0x7A, OpCodeType::NOP, AddressingMode::Implicit),
        OpCode::new(0xDA, OpCodeType::NOP, AddressingMode::Implicit),
        OpCode::new(0xFA, OpCodeType::NOP, AddressingMode::Implicit),

        OpCode::new(0x04, OpCodeType::DOP, AddressingMode::ZeroPage),
        OpCode::new(0x14, OpCodeType::DOP, AddressingMode::ZeroPageX),
        OpCode::new(0x34, OpCodeType::DOP, AddressingMode::ZeroPageX),
        OpCode::new(0x44, OpCodeType::DOP, AddressingMode::ZeroPage),
        OpCode::new(0x54, OpCodeType::DOP, AddressingMode::ZeroPageX),
        OpCode::new(0x64, OpCodeType::DOP, AddressingMode::ZeroPage),
        OpCode::new(0x74, OpCodeType::DOP, AddressingMode::ZeroPageX),
        OpCode::new(0x80, OpCodeType::DOP, AddressingMode::Immediate),
        OpCode::new(0x82, OpCodeType::DOP, AddressingMode::Immediate),
        OpCode::new(0x89, OpCodeType::DOP, AddressingMode::Immediate),
        OpCode::new(0xC2, OpCodeType::DOP, AddressingMode::Immediate),
        OpCode::new(0xD4, OpCodeType::DOP, AddressingMode::ZeroPageX),
        OpCode::new(0xE2, OpCodeType::DOP, AddressingMode::Immediate),
        OpCode::new(0xF4, OpCodeType::DOP, AddressingMode::ZeroPageX),

        OpCode::new(0x0C, OpCodeType::TOP, AddressingMode::Absolute),
        OpCode::new(0x1C, OpCodeType::TOP, AddressingMode::AbsoluteX),
        OpCode::new(0x3C, OpCodeType::TOP, AddressingMode::AbsoluteX),
        OpCode::new(0x5C, OpCodeType::TOP, AddressingMode::AbsoluteX),
        OpCode::new(0x7C, OpCodeType::TOP, AddressingMode::AbsoluteX),
        OpCode::new(0xDC, OpCodeType::TOP, AddressingMode::AbsoluteX),
        OpCode::new(0xFC, OpCodeType::TOP, AddressingMode::AbsoluteX),
        ...
        OpCode::new(0x0B, OpCodeType::AAC, AddressingMode::Immediate),
        OpCode::new(0x2B, OpCodeType::AAC, AddressingMode::Immediate),
    ];
}
